<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="mb-1"><i class="bi bi-clipboard2-data text-primary me-2"></i>Nueva orden</h1>
            <p class="text-muted mb-0">Registra una nueva orden o pedido</p>
        </div>
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-body p-4">
            <form action="{{ $action }}" method="POST" id="orderForm">
                ...
                {{-- Section: Order info --}}
                <div class="mb-1">
                    <h6 class="fw-bold text-primary"><i class="bi bi-receipt me-1"></i> Datos de la orden</h6>
                    <hr class="mt-2">
                </div>
                    ...
                    <div class="col-md-2">
                        ...
                        <select name="order_type" class="form-select" required>
                            @foreach(\App\Models\Order::ORDER_TYPE_LABELS as $val => $label)
                                <option value="{{ $val }}" {{ old('order_type', 'customer') === $val ? 'selected' : '' }}>{{ $label }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-md-2">
                ...
                {{-- Section: Client --}}
                <div class="mb-1">
                    <h6 class="fw-bold text-primary"><i class="bi bi-person me-1"></i> Datos del cliente / proveedor</h6>
                    <hr class="mt-2">
                </div>
                <div class="row g-3 mb-4">
                    <div class="col-md-3">
                        <label class="form-label fw-semibold">Nombre</label>
                        <input type="text" name="client_name" class="form-control" value="{{ old('client_name') }}" placeholder="Nombre">
                    </div>
                    <div class="col-md-2">
                        <label class="form-label fw-semibold">Teléfono</label>
                        <input type="text" name="client_phone" class="form-control" value="{{ old('client_phone') }}" placeholder="Teléfono">
                    </div>
                    <div class="col-md-2">
                        <label class="form-label fw-semibold">Documento</label>
                        <input type="text" name="client_document" class="form-control" value="{{ old('client_document') }}" placeholder="Documento">
                    </div>
                    <div class="col-md-2">
                        <label class="form-label fw-semibold">Email</label>
                        <input type="email" name="client_email" class="form-control" value="{{ old('client_email') }}" placeholder="Email">
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="client_address" class="form-control" value="{{ old('client_address') }}" placeholder="Dirección de entrega">
                    </div>
                    <div class="col-md-3">
                ...
                <div class="d-flex gap-2">
                    <button class="btn btn-primary" type="submit"><i class="bi bi-check-lg me-1"></i> Registrar orden</button>
                    <a href="{{ route('orders.index') }}" class="btn btn-light border">Cancelar</a>
                </div>
            </form>
        </div>
    </div>
