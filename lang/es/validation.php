...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Mensajes de error de validación en español. Resuelve las claves crudas
    | (p. ej. "validation.required") a mensajes legibles e intuitivos.
    |
    */
    ...
    'exists'               => 'El :attribute seleccionado no existe o no es válido.',
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Traduce los nombres técnicos de los campos a etiquetas legibles para que
    | los mensajes digan "El campo almacén destino es obligatorio" en lugar de
    | "El campo warehouse_id es obligatorio".
    |
    */
    ...
    'attributes' => [
        ...
        'quantity_produced' => 'cantidad a producir',
        'discount'          => 'descuento',
        'tax'               => 'impuesto',
        'subtotal'          => 'subtotal',
        'total'             => 'total',
        ...
        'transfer_date'     => 'fecha de traspaso',
